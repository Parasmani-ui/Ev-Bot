...
const getFallbackResponse = (userPrompt: string): string => {
  ...
  if (['hello', 'hi', 'hey', 'help',''].some(word => query === word ||  query.includes(word))) {
...
**Light Goods (< 3.5 Ton GVW):**
• Subsidy: 10% of cost | Max: Rs 30,000

**Medium Goods (3.5-12 Ton):**
• Subsidy: 10% of cost | Max: Rs 1,00,000

**Heavy Goods (> 12 Ton):**
• Subsidy: 10% of cost | Max: Rs 2,00,000

Plus 100% road tax waiver for all categories!
...
**⏱️ Valid Till:** October 5, 2027 (or until unit caps are reached)
